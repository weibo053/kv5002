...
**9** | 25-Mar &nbsp; | [Network Layer: Data plane]({{site.baseurl}}{{site.raurl}}/09-1.pdf) (DK) | [Network Layer: Control plane]({{site.baseurl}}{{site.raurl}}/09-2.pdf) (DK) | [IP addressing and routing exercises](L09.html) (DK)
